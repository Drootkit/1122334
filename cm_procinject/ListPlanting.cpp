...
* Process Injection: ListPlanting T1055.012
* 需要管理员权限，也需要打开注册表，并且展开注册表中的列表，注入后注册表会自动重启一下
*/
...
int ListPlantingExecute() 
{
    ...
    HWND wpw = FindWindow((LPCSTR)"RegEdit_RegEdit", NULL);
